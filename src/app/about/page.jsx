...
export default function About() {
  return (
    <div className="about-main">
      <h1 className="font-bold text-6xl text-center p-3">StayActive Community</h1>
      <div>
        <Image
...
At StayActive, we are here to guide and support you as you complete your wellness journey. Our mission is to empower individuals to take control of their health and well-being through active living.

Our Mission
We aim to promote holistic wellness, provide expert guidance, foster a supportive community, and encourage lifelong fitness.
